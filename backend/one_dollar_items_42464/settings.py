"""
Django settings for one_dollar_items_42464 project.
...
ROOT_URLCONF = 'one_dollar_items_42464.urls'
...
WSGI_APPLICATION = 'one_dollar_items_42464.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "one_dollar_items_42464 API",
    "DESCRIPTION": "API documentation for one_dollar_items_42464 App",
    "VERSION": "v1",
}
